...
nombre_capa = arcpy.Describe(arcpy.GetParameterAsText(0).decode('utf-8')).name
archivo =r"%s\%s_%s.txt"%(ruta_salida,nombre_capa, datetime.datetime.now().strftime("%b_%d_%Y_%H_%M_%S"))
