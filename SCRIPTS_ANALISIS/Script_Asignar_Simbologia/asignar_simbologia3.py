...
campo_calculate = arcpy.GetParameterAsText(6)
label_intervalos = arcpy.GetParameterAsText(7)
...
if __name__ == '__main__':
    ...
    arcpy.SetParameter(8,arcpy.Describe(layer).catalogpath) # fija el parámetro de salida que es un feature class
