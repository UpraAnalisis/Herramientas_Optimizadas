...
scriptAuxiliar="repairx64_aux.py"
...
##    arcpy.AddMessage(verPython)
    ...
    comando=r"start %s %s %s %s"%(verPython,script,infea,delete_null)
    ...
    output=infea
    layer_salida=arcpy.MakeFeatureLayer_management(output,nombre)
    arcpy.SetParameter(2, layer_salida)
