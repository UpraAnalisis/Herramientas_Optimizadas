...
if not arcpy.Exists(pyexe):
    ...
    verPython64=pyexe
    scriptAuxiliar="cost_distancex64_aux_raster_v3.1.py"
...
if __name__ == '__main__':
    ...
    comando=r"start %s %s %s %s %s %s %s %s"%(verPython,script,in_source_raster,in_cost_raster,maximum_distance,out_backlink_raster,extent,capa_salida)
