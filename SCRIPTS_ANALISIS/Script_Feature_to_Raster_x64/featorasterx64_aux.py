...
##        arcpy.MakeRasterLayer_management(ras_objetivo,arcpy.Describe(ras_objetivo).name+"_r")

##        raster.save(ras_objetivo+"_recorte1")
##        print dicti2
##        os.system("pause")
...
##        arcpy.JoinField_management(ras_objetivo, "Value", ras_entrada, "Value", ["%s"%(campo)])
...
##            print "Hola_extent2"
##            print "xxx"+str(arcpy.env.extent)
...
##         print "Hola_mascara"
    ...
    if __name__ == '__main__':
        ...
        if mask!="":
            outTimes = Raster(out_raster) * 1
            outTimes.save(out_raster+"_recorte")
            dict_raster(gdb_salida+"\\"+out_raster,gdb_salida+"\\"+out_raster+"_recorte",field)
##            arcpy.Delete_management(gdb_salida+"\\"+out_raster)
