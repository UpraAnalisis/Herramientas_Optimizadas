...
scriptAuxiliar="unionx64_aux.py"
...
segunda_capa=arcpy.Describe(segunda_capa).catalogPath
join_atributtes=arcpy.GetParameterAsText(2)
...
##    arcpy.AddMessage(verPython)
    ...
    comando=r"start %s %s %s %s %s %s %s %s"%(verPython,script,infea,segunda_capa,join_atributtes,gaps,gdb_salida,capa_salida)
