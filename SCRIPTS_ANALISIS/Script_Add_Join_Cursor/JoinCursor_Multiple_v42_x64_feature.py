...
if not arcpy.Exists(pyexe):
    ...
    verPython64=pyexe
    scriptAuxiliar="JoinCursor_Multiple_v41_x64_feature_aux.py"
...
if __name__ == '__main__':
    ...
    comando=r"start %s %s %s %s %s %s %s"%(verPython,script,fcentrada,llave_objetivo,tablajoin,llave_tabla,("__").join([cambia_caracteres(x) for x in campo_a_unir]))
